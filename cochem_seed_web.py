...
st.set_page_config(page_title="CoChem-SEED - Novice Web UI", layout="wide")

st.title("🔬 CoChem-SEED Control Panel")
...
if st.button("🚀 Execute Default Pipeline"):
    with st.spinner(f"Initializing CoChem-SEED payload for {target_smiles}..."):
        time.sleep(1)
